...
if("TRUE" STREQUAL "TRUE")
  set(svo_ros_SOURCE_PREFIX /home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros)
  set(svo_ros_DEVEL_PREFIX /home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros/build/devel)
  set(svo_ros_INSTALL_PREFIX "")
  set(svo_ros_PREFIX ${svo_ros_DEVEL_PREFIX})
else()
  set(svo_ros_SOURCE_PREFIX "")
  set(svo_ros_DEVEL_PREFIX "")
  set(svo_ros_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros/include " STREQUAL " ")
  set(svo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Christian Forster <forster@ifi.uzh.ch>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'svo_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'svo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(svo_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "svo_ros;svo_nodelet")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT svo_ros_NUM_DUMMY_TARGETS)
      set(svo_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::svo_ros::wrapped-linker-option${svo_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR svo_ros_NUM_DUMMY_TARGETS "${svo_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::svo_ros::wrapped-linker-option${svo_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND svo_ros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rox/svo_gps_ws/src/rpg_svo_pro_gps/svo_ros/build/devel/lib)
...
set(depends "cmake_modules;cv_bridge;image_transport;nodelet;roscpp;nav_msgs;pcl_ros;sensor_msgs;std_msgs;tf;visualization_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(svo_ros_EXPORTED_TARGETS ${${svo_ros_dep}_EXPORTED_TARGETS})
endforeach()
