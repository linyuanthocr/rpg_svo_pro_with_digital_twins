...
namespace svo
{
  ...
  typedef std::shared_ptr<GlobalPositionsHandler> GlobalPositionsHandlerPtr;
  class GlobalPoseHandler;
  typedef std::shared_ptr<GlobalPoseHandler> GlobalPoseHandlerPtr;
  class RawGnssHandler;
  typedef std::shared_ptr<RawGnssHandler> RawGnssHandlerPtr;
