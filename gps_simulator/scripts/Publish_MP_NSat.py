...
class HeightErrorNode:
    def __init__(self):
        ...
        self.multipath_model_path = config['gps_noise_model_multipath']
        self.n_sat_model_path = config['gps_noise_model_number_of_sat']
        self.n_sat_scaler_path = config['gps_noise_model_number_of_sat_scaler']
    ...
    def publish_errors(self, errors):
        ...
        rospy.loginfo(f"Published errors: {errors}")
    ...
    def publish_nsat(self, nsat: int):
        ...
        rospy.loginfo(f"Published number of satellites: {nsat}")
