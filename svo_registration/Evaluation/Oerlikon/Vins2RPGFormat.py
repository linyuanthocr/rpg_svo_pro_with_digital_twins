...
def write_to_csv_pose(filename, messages):
    k=0
    with open(filename, 'w') as csvfile:
        writer = csv.writer(csvfile, delimiter=' ')
        csvfile.write("# time x y z qx qy qz qw\n")
...
ground_truth_topic = '/col_T_enu_b' #kingfisher/agiros_pilot/groundtruth/pose' #/col_T_enu_b' #/kingfisher/agiros_pilot/groundtruth/pose' #/vio/odometry' #/kingfisher/agiros_pilot/groundtruth/pose' #/vio/odometry' #/groundtruth/pose' #/kingfisher/agiros_pilot/groundtruth/pose' #ground_truth/xyz' #/kingfisher/agiros_pilot/groundtruth/pose' #'ground_truth/xyz'
estimated_pose_topic = '/vins_estimator/odometry' #/globalEstimator/global_odometry' #/svo/vio_backend_pose_imu_viz' #/svo/vio_backend_pose_imu_viz' #/map_alignement_T_w_b' #/svo/vio_backend_pose_imu_viz' #/svo/pose_cam/0' #/svo/vio_backend_pose_imu' #/svo/pose_imu' #/svo/vio_backend_pose_imu_viz' #/svo/pose_imu' #/svo/vio_backend_pose_imu_viz'
...
write_to_csv_pose(os.path.join(result_dir, 'stamped_groundtruth.txt'), ground_truth_msgs)
# write_to_csv_odo(os.path.join(result_dir, 'stamped_groundtruth.txt'), ground_truth_msgs)
# write_to_csv_pose(os.path.join(result_dir, 'stamped_traj_estimate.txt'), estimated_pose_msgs)
